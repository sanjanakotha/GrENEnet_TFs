#!/bin/bash
#SBATCH --job-name=dask_all_preds_tair_arabidopsis
...
#SBATCH --output=/global/scratch/projects/fc_mvslab/OpenProjects/Sanjana/collaborations/GrENEnet_TF_hits/03_predictor_log.out
## Command(s) to run:
...
INPUT_FILE="/global/scratch/projects/fc_mvslab/OpenProjects/Sanjana/collaborations/GrENEnet_TF_hits/01c_tair_arabidopsis_cleaned.fasta"
OUTPUT_DIR="/global/scratch/projects/fc_mvslab/OpenProjects/Sanjana/collaborations/GrENEnet_TF_hits/04_predictor_results"
